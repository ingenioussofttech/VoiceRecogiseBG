...
- (void) activateMode
{
    ...
    NSLog(@"active mode");
    bgtimer = [NSTimer scheduledTimerWithTimeInterval:1 target:self  selector:@selector(callinbackground) userInfo:nil repeats:YES];
    
    [[NSRunLoop currentRunLoop] addTimer:bgtimer forMode:NSDefaultRunLoopMode];
